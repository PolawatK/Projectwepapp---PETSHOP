                            ...
                            $result = $conn->query($sql);
                                if ($result->num_rows > 0) {
                                    while($row = $result->fetch_assoc()) {
                                        echo"<tr>
                                                <td>".$row["cus_id"]."</td>"."<td>".$row["cus_fname"]." ".$row["cus_lname"]."</td>"."<td>".$row["cus_username"]."</td>"."<td>".$row["cus_phone"]."<td>".$row["cus_email"]."</td>"."<td>".$row["cus_address"]."</td>"."<td>"."<a href='editcus.php?cus_id=".$row["cus_id"]."'><button> เเก้ไข </button></a>"."</td>";
                                        echo "</tr>";    
                                    }
                                }else {
                                    echo "0 results";
